...
def unet_model(input_size=(96, 128, 3), n_filters=32, n_classes=23):
    ...
    cblock4, skip4 = conv_block(cblock3, n_filters * 8, dropout_prob=0.3) # Include a dropout_prob of 0.3 for this layer
    # Include a dropout_prob of 0.3 for this layer, and avoid the max_pooling layer
    cblock5, skip5 = conv_block(cblock4, n_filters * 16, dropout_prob=0.3, max_pooling=False) 
